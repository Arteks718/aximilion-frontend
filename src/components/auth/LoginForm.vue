<template>
  <form @submit.prevent="onSubmit" class="space-y-6">
    ...
    <div class="space-y-2">
      <label class="text-xs font-bold uppercase tracking-widest text-[#3c4a42] font-label" for="email">Email Address</label>
      <div class="relative">
        <input 
          v-model="email" 
          type="email" 
    ...
    <div class="space-y-2">
      <div class="flex justify-between items-center">
        <label class="text-xs font-bold uppercase tracking-widest text-[#3c4a42] font-label" for="password">Password</label>
        <a class="text-xs font-medium text-[#006C49] hover:underline" href="#">Forgot Password?</a>
      </div>
      <div class="relative">
        <input 
          v-model="password" 
